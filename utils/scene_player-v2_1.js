...
var ScenePlayerV2 = function (/**async function()**/obtain_scene_content_func) {
    ...
    var narrative = function () {
        ...
        ret.addEventListener("onreset", () => {
            ...
            narrative_div && narrative_div.remove();
        })

        ret.addEventListener("onsetupui", () => {
            narrative_div = document.createElement("div")
            ...
            narrative_msg = document.createElement("span")
    ...
    var speech = function () {
        ...
        ret.addEventListener("onsetupui", () => {
            ...
            speech_msg = document.createElement("div");
    ...
    var standing = function () {
        ...
        ret.addEventListener("onreset", () => {
            ...
            Object.values(standing_img).forEach(d => d && d.remove());
            standing_img = {};
        });
    ...
    var anim = function () {
        ...
        ret.addEventListener("onreset", () => {
            anim_div && anim_div.remove();
        })

        ret.addEventListener("onsetupui", () => {
            anim_div = document.createElement("canvas");
            anim_div.id = "player_anim_canvas";
            anim_div.width = 1920;
